...
def exit_reset():
    global run,dk,ct_rl,ct_dc,ct, LED
    global dl_BT1, dl_BT2, dl_BT3, dl_BT4,vb1,vb2, score_font  # chỉ để test
    while run:
        if dl_BT3==True and dl_BT4==True:
            ...
            time.sleep(0.5)
            vb1='thanks'.center(16,' ')
            value1 = score_font.render(str(vb1), True, (255,0,0))
            dis.blit(value1, [30,0])
            vb2='everyone'.center(16,' ')
            value2 = score_font.render(str(vb2), True, (255,0,0))
...
def mo_phong():
    global vb1, vb2, dl_BT1, dl_BT2, dl_BT3, dl_BT4, run, ma, dis, image, w, h, black, clock, LED,n1,n2, ct_rl, ct_dc, score_font
    pygame.init()
